...
public class AddChoiceAddsChoiceToTheVoteTest extends ChoiceTestBase {
  ...
  public void created_choice_is_registered_with_the_vote() {
    choice = choiceService.addChoice(new VoteAdminInfo(vote.getId(), vote.getAdminKey()), "choice1",
        "user");
  ...
  public void if_no_user_then_null_is_Registered() {
    final Choice newChoice = choiceService
        .addChoice(new VoteAdminInfo(vote.getId(), vote.getAdminKey()), "choice", null);
  ...
  public void choice_ids_are_unique() {
    final VoteAdminInfo adminInfo = new VoteAdminInfo(vote.getId(), vote.getAdminKey());
