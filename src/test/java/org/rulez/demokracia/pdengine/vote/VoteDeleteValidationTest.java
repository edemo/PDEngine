...
public class VoteDeleteValidationTest extends ThrowableTester {
  ...
  public void invalid_voteId_is_rejected() {
    assertThrows(() -> voteService.deleteVote(new VoteAdminInfo(INVALID_VOTE_ID, "ADMIN")))
  ...
  public void invalid_adminKey_is_rejected() {
    ...
    assertThrows(() -> voteService.deleteVote(new VoteAdminInfo(validVoteId, invalidAdminKey)))
