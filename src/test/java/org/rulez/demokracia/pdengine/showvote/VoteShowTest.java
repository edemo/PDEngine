...
public class VoteShowTest extends ShowVoteTestBase {
	...
	@Before
	public void setUp() {
		vote = new Vote("votename", List.of("needed1", "needed2"), List.of("counted1", "counted2"), true, 3);
	...
	public void the_name_attribute_contains_the_name_of_the_vote() {
		JsonObject result = showVoteService.showVote(new VoteAdminInfo(voteId,
				adminKey));
	...
	public void the_creationTime_attribute_contains_the_creation_time_of_the_vote() {
		...
		assertEquals(result.get(CREATION_TIME).getAsLong(),
	...
	public void the_choices_attribute_contains_the_choices_of_the_vote() {
		...
		assertEquals(vote.getChoices().size(),
				result.get(CHOICES).getAsJsonObject().entrySet().size());
	}

	@Test
	public void the_initiator_of_the_choice_is_in_the_json() {
		JsonObject choicesJson = showVoteService.showVote(new VoteAdminInfo(voteId,
				adminKey)).get(CHOICES).getAsJsonObject();
	...
	public void the_countedAssurances_attribute_contains_the_counted_assurances_of_the_vote() {
		...
		assertJsonContainsAllElement(jsonCountedAssurances,
	...
	public void the_neededAssurances_attribute_contains_the_needed_assurances_of_the_vote() {
		...
		assertJsonContainsAllElement(jsonNeededAssurances,
