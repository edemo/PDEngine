...
public class ForShowVoteTheUserNeedsACountedAssuranceTest extends ShowVoteTestBase {
  ...
  @Test
  public void a_user_with_not_all_assourances_cannot_show_the_vote_even_with_more_assurances() {
  ...
  private void assertAssurancesMissing(final Vote vote) {
    ...
    assertThrows(() -> showVoteService.showVote(aminInfo)).assertMessageIs("missing assurances");
  }
