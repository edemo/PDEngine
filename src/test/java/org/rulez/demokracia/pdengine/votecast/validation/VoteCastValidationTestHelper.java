...
public final class VoteCastValidationTestHelper {
  ...
  public static List<RankedChoice>
      prepareCastVote(final Vote vote, final boolean canVote) {
    final List<RankedChoice> theCastVote = new ArrayList<>();
    vote.getParameters().setVotable(canVote);
    return theCastVote;
  }

  public static void prepareRankedChoice(
  ...
  public static void newChoiceAndRankedList(
