...
public class ObtainBallotAdminKeyTest extends ObtainBallotTestBase {
  ...
  public void if_the_user_does_not_have_all_the_needed_assurances_then_she_cannot_vote() {
    assertThrows(() -> ballotService.obtainBallot(createVote(List.of(DONT_HAVE)), USER))
  ...
  public void admin_can_obtain_more_ballots() {
    ...
    String ballotAdmin1 = ballotService.obtainBallot(vote, vote.getAdminKey());
    String ballotAdmin2 = ballotService.obtainBallot(vote, vote.getAdminKey());
  ...
  public void not_logged_in_user_cannot_issue_any_ballot() {
    ...
    assertThrows(() -> ballotService.obtainBallot(createVote(List.of(HAVE)), USER))
