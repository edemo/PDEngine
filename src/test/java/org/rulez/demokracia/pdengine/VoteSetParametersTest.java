...
public class VoteSetParametersTest extends CreatedDefaultVoteRegistry {
  ...
  public void setUp() {
    ...
    voteManager.setVoteParameters(
        new VoteAdminInfo(adminInfo.voteId, adminInfo.adminKey), voteParameters
    );
  }
  ...
  public void invalid_voteId_is_rejected() {
    ...
    assertThrows(
        () -> {
          voteManager.setVoteParameters(
              new VoteAdminInfo(voteName, adminInfo.adminKey), voteParameters
          );
        }
  ...
  public void invalid_adminKey_is_rejected() {
    ...
    assertThrows(
        () -> voteManager.setVoteParameters(
            new VoteAdminInfo(adminInfo.voteId, invalidAdminKey), voteParameters
        )
